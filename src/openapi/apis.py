...
class APIs:
    ...
    def get_api(self, request: operations.GetAPIRequest) -> operations.GetAPIResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getAPI', oauth2_scopes=[], security_source=None)
    ...
    def get_metrics(self) -> operations.GetMetricsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getMetrics', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get_provider(self, request: operations.GetProviderRequest) -> operations.GetProviderResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getProvider', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetProviderResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_providers(self) -> operations.GetProvidersResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getProviders', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetProvidersResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetProvidersResponseBody])
                res.object = out
            else:
                content_type = http_res.headers.get('Content-Type')
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
    ...
    def get_service_api(self, request: operations.GetServiceAPIRequest) -> operations.GetServiceAPIResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getServiceAPI', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetServiceAPIResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_services(self, request: operations.GetServicesRequest) -> operations.GetServicesResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getServices', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetServicesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetServicesResponseBody])
                res.object = out
            else:
                content_type = http_res.headers.get('Content-Type')
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
    ...
    def list_ap_is(self) -> operations.ListAPIsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='listAPIs', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.ListAPIsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
